...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('En este apartado puedes editar tu información.'),
        'class' => 'col-lg-7'
    ])   
                        ...
                        <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="input-password-confirmation">{{ __('Confirma la nueva contraseña') }}</label>
